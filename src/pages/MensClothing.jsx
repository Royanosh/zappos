...
<div style={style.div}>
  ...
  <div className='container'>
       <img  src="https://m.media-amazon.com/images/G/01/2022/Mens/MENS-SWEATERS-HOODIES-OCTOBER-HERO-1440x700.jpg" alt="" />
    </div>
      ...
      <div>
          <div style={{width:"100%",margin:"auto",marginLeft:"20px",margin:"20px"}} >
            ...
            <h1 style={{fontSize:"30px"}}>Fall in Love with Free people</h1>
              <h4 style= {{marginTop:"20px",fontSize:"22px",paddingLeft:"10px"}}>kick-start the new season with cozy-chic <br /> tops,timelwss denim, midi dresses , and si much more!</h4>
              <div style={{fontSize:"28px"}}>
                <button type="button"  style={{fontSize:"18px",border:"2px solid black",fontWeight:"bold",padding:"5px 10px",marginTop:"20px"}} >SHOP WOMEN'S COATS & OUTERWEAR</button>
              </div>
            </div>
            </div>
        </div>
